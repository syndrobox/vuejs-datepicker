<template>
  <div class="vdp-datepicker" :class="[wrapperClass, isRtl ? 'rtl' : '']">
    <div class="input-group">
      <!-- Calendar Button -->
      <span class="vdp-datepicker__calendar-icon" class="input-group-prepend input-group-icon align-items-center" v-if="calendarIcon" @click="showCalendar" v-bind:style="{'cursor:not-allowed;' : disabledPicker}">
